...
function doGet(e) {
  ...
  return ContentService.createTextOutput(
    JSON.stringify({ error: "Invalid sheet parameter" }),
...
function getWorksData() {
  ...
  return ContentService.createTextOutput(JSON.stringify({ works })).setMimeType(
...
function notifyNextJS() {
  const url =
    "https://your-app.vercel.app/api/revalidate?secret=YOUR_SECRET&path=/works";
